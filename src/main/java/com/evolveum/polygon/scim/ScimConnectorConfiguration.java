...
public class ScimConnectorConfiguration extends AbstractConfiguration implements StatefulConfiguration {
	...
	@ConfigurationProperty(order = 1, displayMessageKey = "Username",
            groupMessageKey = "basic.group", helpMessageKey = "Please provide the administrator user name for the scim enabled service you are logging into", required = true,
            confidential = false)
    ...
    @ConfigurationProperty(order = 5, displayMessageKey = "Scim endpoint",
            groupMessageKey = "basic.group", helpMessageKey = "Please provide the scim endpoint of the service provider (eg. /services/scim)", required = true,
            confidential = false)
    ...
    @ConfigurationProperty(order = 7, displayMessageKey = "Login url",
            groupMessageKey = "basic.group", helpMessageKey = "Please provide the Url address for log in", required = true,
            confidential = false)
    ...
    @ConfigurationProperty(order = 8, displayMessageKey = "Service Grant",
            groupMessageKey = "basic.group", helpMessageKey = "Please provide the ulr snippet defining the service and grand type to log into the service (eg. /services/oauth2/token?grant_type=password)", required = true,
            confidential = false)
